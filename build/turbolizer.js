  ...
  class GraphNode extends Node$1 {
      ...
      hasBackEdges() {
          return (this.nodeLabel.opcode === "Loop") ||
              ...
              (this.nodeLabel.opcode === "LOOP_BEGIN" ||
                  this.nodeLabel.opcode === "LOOP_BACK" ||
                  this.nodeLabel.opcode === "DEPEND_SELECTOR" ||
                  this.nodeLabel.opcode === "VALUE_SELECTOR");
      }
      equals(that) {
          if (!that)
              return false;
      ...
      initWorkList(startNodes) {
          ...
          while (workList.length != 0) {
              ...
              if (node.nodeLabel.opcode === "Phi" ||
                  ...
                  node.nodeLabel.opcode === "DEPEND_RELAY") {
  ...
  class GraphView extends MovableView {
      ...
      updateGraphVisibility() {
          ...
          const newEdges = selEdges
              ...
              .classed("root", edge => edge.type === "root");
...
<div class="graph-toolbox">
  ...
  class Snapper {
      ...
      disassemblyUpdate(isDisassemblyExpanded) {
          storageSetItem("expandedState-disassembly", false);
